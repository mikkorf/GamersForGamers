...
<div class="d-flex justify-content-center flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-2">
    <h1 class="h2">Create New Tips & Tricks Blog</h1>
</div>
...
<div class="col-lg-8 mb-5" style="color: white; background-color: #191919; padding: 20px; border-radius: 20px;">
    <form method="post" action="/tipPosts" class="" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <button type="submit" class="btn" style="background-color: #8c52ff; color: #fffccf !important; text-decoration: none;">Create Tips & Tricks Blog</button>
    </form>
</div>
</div>
